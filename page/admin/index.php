                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Data Permintaan</div>
                                            <?php
                                                include '../../core/koneksi.php';
                                                $data_permintaan = mysqli_query($konek, "SELECT*FROM permintaan");
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Data Permintaan yang Selesai</div>
                                            <?php
                                                include '../../core/koneksi.php';
                                                $data_permintaan = mysqli_query($konek, "SELECT * FROM permintaan WHERE status='selesai'");
                                                $jumlah_permintaan = mysqli_num_rows($data_permintaan);
                                            ?>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_permintaan; ?> Permintaan</div>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Data Mekanik</div>
                                            <?php
                                                include '../../core/koneksi.php';
                                                $data_mekanik = mysqli_query($konek, "SELECT*FROM mekanik");
                                                $jumlah_mekanik = mysqli_num_rows($data_mekanik);
                                            ?>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_mekanik; ?> Orang</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                ...
                                                ?>
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $jumlah_admin; ?> Orang</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php
                                                include '../../core/koneksi.php';
                                                $total_harga=0;
                                                while ($data = mysqli_fetch_array($data_permintaan)) { $total_harga += $data['biaya'];}
                                            ?>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Rp.<?php echo $total_harga; ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-2x text-gray-300"></i>
                                        </div>
