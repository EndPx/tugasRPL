                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4 col-xl-3 col-md-6 mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Detail Mekanik</h1>
                        </div>
                    </div>
                    <hr>
                        ...
                        <div class="col-sm-8">
                            <div class="card shadow">
                                <div class="card-body">
                                        ...
                                        <div class="col-md-8">
										    <table class="table table-borderless">
                                                ...
                                                <tr>
                                                    <td>Gaji</td>
                                                    <td>:</td>
                                                    <td><b><?php echo $row["gaji"]?></b></td>
                                                </tr>
                                                <tr>
                                                    <td>Bonus</td>
                                                    <td>:</td>
                                                    <td><b><?php echo $row["bonus"]?></b></td>
                                                </tr>
                                                <tr>
                                                    <td>Status</td>
                                                    <td>:</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>:</td>
                                                    <td><b><?php echo $row["total_permintaan"]?></b></td>
                                                </tr>
                                            </table>
                                        </div>	
									</div>
                                    <div>
                                        <div class="col">
                                            <a href='editMekanik.php?id=<?php echo $row['id']; ?>' class="btn btn-sm btn-info"><i class="fa fa-pen"></i> Ubah</a>
                                            ...
                                            <a href='mekanik.php' class='btn btn-sm btn-secondary'><i class='fas fa-caret-left'></i> Back</a>
									    </div>
                                    </div>				
                                </div>
                            </div>
