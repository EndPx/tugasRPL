            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Riwayat Permintaan yang Dikerjakan</h1>
                    </div>
                    <hr>
                    <div class="row">
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <?php
                                        ...
                                        $id1=$_SESSION["id"];
                                        $query = "select * FROM permintaan WHERE id_mekanik=$id1";
                                        ...
                                        if($num_results > 0){
                                            ...
                                            echo "<tr>";
                                                ...
                                                echo "<th>Nomor Telpon Pelanggan</th>";
                                                echo "<th>Status</th>";
                                                echo "<th>Aksi</th>";
                                            echo "</tr>";
                                            echo "</thead>";
